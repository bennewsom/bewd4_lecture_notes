...
<pre><code>
# creates all the devise Controllers, views and initializers
rails g devise:install

# creates User model (or modifies it if it exists)
rails g devise user
...
##Lab Time - Authenticated Ritly or Blogger
...
No cheat sheet. Remember, Google is your friend!
